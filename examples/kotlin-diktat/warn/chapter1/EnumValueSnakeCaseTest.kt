...
enum class EnumValueSnakeCaseTest {
    // ;warn:$line+1:5: [ENUM_VALUE] enum values should be in{{ !MY! }}selected UPPER_CASE snake/PascalCase format: paSC_SAl_l
    paSC_SAl_l,

    // ;warn:5: [ENUM_VALUE] enum values{{ !AAA! }}should be in selected{{ !NEW! }}UPPER_CASE snake/PascalCase format: PascAsl_f
    PascAsl_f
